...
st.markdown(
    ...
    2.[**"P. CARAFA, M. G. CRESPI, M. T. D’ALESSIO, FABIANI U.. L'utilizzo delle tecnologie geomatiche e la Forma Urbis: un nuovo approccio. In Bullettino della
        Commissione Archeologica Comunale di Roma, CXII 2011."
    ...
    4.[**B. E. BARICH, M. G. CRESPI,   FABIANI U., G. LUCARINI. Tecniche geomatiche applicate alla ricerca archeologica   in ambienti   desertici:   il caso della Missione Archeologica Italiana nell'Oasi di Farafra (Egitto). 13º Conferenza ASITA (Federazione delle Associazioni Scientifiche per le Informazioni Territoriali e Ambientali). Bari (Italia), Dicembre 2009.
    5.[**B. E. BARICH, M. G. CRESPI, FABIANI U., G. LUCARINI, (in press) Geomatics resources for archeological survey in desert areas - Someprospects from Farafra Oasis. Dakhleh Oasis Project Sixth International Conference. New Perspectives on the Western Desert of Egypt. Università del Salento - Monash University - New York University, Lecce (Italia), Settembre 2009.
    6.[**	"FABIANI U., F. FRAIOLI (2010). Sull’allineamento del Tempio di Venere e Roma. In: AIAC XVII CONGRESSO INTERNAZIONALE DIARCHEOLOGIA CLASSICA.
        ROMA, 22-26 SETTEMBRE 2008 (http://www.fastionline.org/docs/FOLDER-it-2010-193.pdf)."
    ...
    9.[**	"V. BAIOCCHI, M. ANZIDEI, A. ESPOSITO, FABIANI U., G. PIETRANTONIO, F. RIGUZZI  (2007). Intégrer bathymétrie et lidar.GÉOMATIQUE
    EXPERT, ISSN: 1620 4859."
    10.[**	"BAIOCCHI V, FABIANI U., MAZZONI A, PIETRANTONIO G, RIGUZZI F (2007). Integrated DTM of the Albano and Nemi craters (central Italy) permit
    morphological updates. JOURNAL OF VOLCANOLOGY AND GEOTHERMAL RESEARCH, ISSN: 0377-0273."
    ...
    17.[**	"M. G. CRESPI, L. DE VENDICTIS, FABIANI U., L. LUZIETTI, A. MAZZONI (2006). Applicazioni nel campo del posizionamento di precisione in tempo reale supportato
    da una rete di stazioni permanenti GNSS: Resnap GPS e l’esperienza nel Lazio. In: ASITA. BOLZANO, 14-18 NOVEMBRE."
    18.[**	"V. BAIOCCHI, M. G. CRESPI, FABIANI U., P. MACCIACCHERA, M. NEGRETTI, P. ZATELLI (2005). Implementation of datumtransformations for the
    italian territory in grass: methodology, problems and experiments. GEOMATICS WORKBOOKS, vol. 5, ISSN: 1591-092X."
    19.	"M. G. CRESPI, L. DE, VENDICTIS, FABIANI U., L. LUZIETTI, A, MAZZONI (2005). The Archaeological information system of theunderground of Rome: a
    challenging proposal for the next future. In XX CIPA International Symposium Torino 27 settembre – 01 ottobre 2005."
    20.[**	"M. G. CRESPI, L. DE VENDICTIS, FABIANI U., L. LUZIETTI, A. MAZZONI (2005). Un sistema informativo territoriale globale per la gestione dei dati di scavo di
    Roma: una proposta operativa. In: Convegno Nazionale SIFET (Società Fotogrammetria e Topografia) Mondello (Palermo) dal 29/06 al 01/07  2005."
